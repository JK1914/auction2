...
<div style="width: 100%;
    ...
    <form method="post" action="/register" style="position: relative;
    z-index: 1;
    background: #FFFFFF;
    max-width: 360px;
    margin: 0 auto 100px;
    ...
    box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24);">
        @csrf
        <input type="text" name="name" style="font-family: 'Roboto', sans-serif; outline: 0; background: #f2f2f2; width: 100%; border: 0; margin: 0 0 15px; padding: 15px; box-sizing: border-box; font-size: 14px;" placeholder="Имя">
        <br>
        ...
        <br>
        <button style="font-family: 'Roboto', sans-serif; text-transform: uppercase; outline: 0; background: #4CAF50; width: 100%; border: 0; padding: 15px; color: #FFFFFF;">Регистрация</button>
    </form>
</div>